...
export default function App() {
  ...
  // Load Adsterra Ads & Register PWA
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      script1.src = "https://www.highperformanceformat.com/04186cbc5baf73e8902ddcf9b1dc6923/invoke.js";
      script1.async = true;
      script1.onerror = () => console.log('Ad 1 failed to load');
      ...
      setTimeout(() => {
        ...
        script2.src = "https://www.highperformanceformat.com/3313991/invoke.js";
        script2.async = true;
        script2.onerror = () => console.log('Ad 2 failed to load');
      ...
      setTimeout(() => {
        ...
        script3.async = true;
        script3.onerror = () => console.log('Native ad failed to load');
  ...
  return (
    <div style={{ 
      ...
      <div style={{ width: "100%", maxWidth: 430, display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
        ...
        <div style={{ padding: "0 10px", flex: 1, overflow: "auto", display: "flex", flexDirection: "column" }}>
